...
const FRAMEWORKS: ReadonlyArray<{
  ...
  { key: "logto", label: "Logto ✓", highlight: true },
...
const COMPARISON_DATA: ReadonlyArray<Row> = [
  ...
  { kriter: "Resmi Bulut",        keycloak: "Yok (RH ticari)", authentik: "Enterprise tier", zitadel: "zitadel.com",           logto: "cloud.logto.io",  supertokens: "supertokens.com",   casdoor: "casdoor.com" },
